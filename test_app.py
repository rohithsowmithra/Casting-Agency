...
class CastAgencyTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # self.database_path = os.environ.get('DATABASE_URL_LOCAL')
    ...
    def test_get_all_movies(self):
        ...
        # self.assertTrue(resp_data['movies'][0]['actors'])
    ...
    def test_get_all_actors(self):
        ...
        # self.assertTrue(resp_data['actors'][0]['movies'])
